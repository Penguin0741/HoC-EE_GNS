...
execute @a[tag=main_player,tag=note_1,tag=note_2,tag=note_3,tag=note_4,tag=note_5,tag=note_6,tag=note_7,tag=note_8,tag=note_9,tag=note_10,tag=!trophy_book] ~ ~ ~ function trophy/unlock_book
