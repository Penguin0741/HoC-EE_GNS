...
tag @s[x=-100,y=82,z=62,r=5] add in_area
...
execute @s[tag=!dlgopened,scores={var1=0..3}] ~ ~ ~ dialogue open @e[type=rwm:fake_agent,c=1] @s npc.agent.red.8.1

execute @s[scores={var1=0}] ~ ~ ~ particle rwm:sparkle -100 82 62
execute @s[scores={var1=0,second=0},tag=in_area] ~ ~ ~ particle rwm:interact -99 82 62

execute @s[scores={var1=0}] ~ ~ ~ detect -100 82 62 polished_blackstone_button 9 function act/7/1

# Load sequence
execute @s[scores={var1=120}] ~ ~ ~ function act/7/load_1
...
execute @s[scores={var1=22}] ~ ~ ~ detect -149 69 29 air 0 scoreboard players add @s var1 1
execute @s[scores={var1=22}] ~ ~ ~ function act/7/load_2
