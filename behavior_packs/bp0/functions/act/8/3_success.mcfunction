...
execute @s[scores={tick=100}] ~ ~ ~ event entity @e[type=rwm:wind_knockback] despawn
execute @s[scores={tick=100}] ~ ~ ~ fill -118 77 184 -120 77 184 air
execute @s[scores={tick=100}] ~ ~ ~ function act/8/4
