...
execute @s[tag=!touch] ~ ~ ~ titleraw @a actionbar {"rawtext":[{"translate":"actionbar.keyboard.10.9"}]}
execute @s[tag=touch] ~ ~ ~ titleraw @a actionbar {"rawtext":[{"translate":"actionbar.touch.10.9"}]}

execute @s[tag=!dlgopened] ~ ~ ~ dialogue open @e[type=rwm:fake_agent] @s npc.agent.7.1
