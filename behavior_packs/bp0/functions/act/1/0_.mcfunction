...
tag @s[x=38,y=72,z=89,r=5] add in_area
...
execute @s[tag=!dlgopened,scores={var1=0..3}] ~ ~ ~ dialogue open @e[type=rwm:fake_agent,c=1] @s npc.agent.green.8.1

execute @s[scores={var1=0}] ~ ~ ~ particle rwm:sparkle 38 72 89
execute @s[scores={var1=0,second=0},tag=in_area] ~ ~ ~ particle rwm:interact 38 72 88

execute @s[scores={var1=0}] ~ ~ ~ detect 38 72 89 stone_button 9 function act/1/1

# Load sequence
execute @s[scores={var1=120}] ~ ~ ~ function act/1/load_1
...
execute @s[scores={var1=22}] ~ ~ ~ detect 7 69 61 air 0 scoreboard players add @s var1 1
execute @s[scores={var1=22}] ~ ~ ~ function act/1/load_2
