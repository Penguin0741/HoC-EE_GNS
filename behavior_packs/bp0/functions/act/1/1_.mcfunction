...
execute @s[tag=end_signal] ~ ~ ~ execute @c[x=36,y=72,z=91,dx=0,dy=0,dz=0] ~ ~ ~ scoreboard players add @a address 1
execute @s[tag=end_signal,scores={address=10100}] ~ ~ ~ scoreboard players add @a address 2
