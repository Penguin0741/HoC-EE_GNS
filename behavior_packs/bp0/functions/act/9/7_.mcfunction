...
execute @s[tag=start_signal] ~ ~ ~ structure load "room9:yellowline" -137 73 118
execute @s[tag=start_signal] ~ ~ ~ structure load "room9:redline" -140 73 118
...
execute @s[scores={var1=1,var2=0}] ~ ~ ~ event entity @e[tag=laser1] length_1
execute @s[scores={var1=1,var2=1}] ~ ~ ~ event entity @e[tag=laser1] length_4
execute @s[scores={var1=1,var2=2}] ~ ~ ~ event entity @e[tag=laser1] length_7
execute @s[scores={var1=1,var2=3}] ~ ~ ~ event entity @e[tag=laser1] length_10
execute @s[scores={var1=1,var2=0..2}] ~ ~ ~ setblock -143 72 119 iron_block
execute @s[scores={var1=1,var2=3}] ~ ~ ~ setblock -143 72 119 redstone_block

execute @s[scores={var1=1,var4=0}] ~ ~ ~ event entity @e[tag=laser2] length_1
execute @s[scores={var1=1,var4=1}] ~ ~ ~ event entity @e[tag=laser2] length_4
execute @s[scores={var1=1,var4=2}] ~ ~ ~ event entity @e[tag=laser2] length_7
execute @s[scores={var1=1,var4=3}] ~ ~ ~ event entity @e[tag=laser2] length_10
execute @s[scores={var1=1,var4=0..2}] ~ ~ ~ setblock -143 72 123 iron_block
execute @s[scores={var1=1,var4=3}] ~ ~ ~ setblock -143 72 123 redstone_block

execute @s[scores={var1=1,var5=0}] ~ ~ ~ event entity @e[tag=laser3] length_1
execute @s[scores={var1=1,var5=1}] ~ ~ ~ event entity @e[tag=laser3] length_4
execute @s[scores={var1=1,var5=2}] ~ ~ ~ event entity @e[tag=laser3] length_7
execute @s[scores={var1=1,var5=3}] ~ ~ ~ event entity @e[tag=laser3] length_10
execute @s[scores={var1=1,var5=0..2}] ~ ~ ~ setblock -143 72 125 iron_block
execute @s[scores={var1=1,var5=3}] ~ ~ ~ setblock -143 72 125 redstone_block

# Code stops running
execute @s[tag=end_signal,scores={var2=3,var4=3,var5=3}] ~ ~ ~ scoreboard players add @s address 1
execute @s[tag=end_signal,scores={address=90700}] ~ ~ ~ scoreboard players add @s address 2