...
execute @s[scores={var1=1,var2=2}] ~ ~ ~ event entity @e[tag=laser1] length_10
execute @s[scores={var1=1,var2=0..1}] ~ ~ ~ setblock -143 72 119 iron_block
execute @s[scores={var1=1,var2=2}] ~ ~ ~ setblock -143 72 119 redstone_block
...
execute @s[scores={var1=1,var4=2}] ~ ~ ~ event entity @e[tag=laser2] length_10
execute @s[scores={var1=1,var4=0..1}] ~ ~ ~ setblock -143 72 123 iron_block
execute @s[scores={var1=1,var4=2}] ~ ~ ~ setblock -143 72 123 redstone_block
...
execute @s[scores={var1=1,var5=2}] ~ ~ ~ event entity @e[tag=laser3] length_10
execute @s[scores={var1=1,var5=0..1}] ~ ~ ~ setblock -143 72 125 iron_block
execute @s[scores={var1=1,var5=2}] ~ ~ ~ setblock -143 72 125 redstone_block

# Code stops running
execute @s[tag=end_signal,scores={var2=2,var4=2,var5=2}] ~ ~ ~ scoreboard players add @s address 1
execute @s[tag=end_signal,scores={address=90600}] ~ ~ ~ scoreboard players add @s address 2